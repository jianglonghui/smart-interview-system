...
exports.morganStream = exports.requestLogger = exports.logger = void 0;
...
const transports = [
    ...
    new winston_1.default.transports.File({
        filename: path_1.default.join(config_1.config.logDir, 'error.log'),
        level: 'error',
        format: fileFormat,
    }),
    new winston_1.default.transports.File({
        filename: path_1.default.join(config_1.config.logDir, 'combined.log'),
        format: fileFormat,
    }),
];
...
exports.requestLogger = winston_1.default.createLogger({
    ...
    transports: [
        new winston_1.default.transports.File({
            filename: path_1.default.join(config_1.config.logDir, 'requests.log'),
        }),
    ],
});
