...
export declare const crawlerRateLimitMiddleware: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const uploadRateLimitMiddleware: (req: Request, res: Response, next: NextFunction) => Promise<void>;
